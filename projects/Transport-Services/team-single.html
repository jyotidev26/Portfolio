		...
		<div class="container">
				...
				<div class="row">
					<div class="col-lg-5">
						<div class="ft-team-details-img position-relative">
							<img src="assets/img/team/tmd1.jpg" alt="">
						</div>
					</div>
					<div class="col-lg-7">
						<div class="ft-team-details-text-wrapper headline pera-content">
							...
							<div class="ft-team-details-info ul-li-block">
								<ul>
									...
									<li><span>Email:</span> fastrans@mail.com</li>
									<li><span>Phone:</span> +1 (880) 444 35 35</li>
			...
			<div class="ft-team-personal-form-cta-wrapper">
				<div class="row">
					...
					<div class="col-lg-3">
						<div class="ft-team-personal-cta text-center" data-background="assets/img/bg/td-bg.png">
