						...
						<div class="mobile_menu_wrap">
							...
							<div class="mobile_menu_content">
								...
								<div class="m-brand-logo">
									<a href="!#"><img src="assets/imgs/logo/logo4.png" alt=""></a>
								</div>
	...
	<section id="ft-thx-slider" class="ft-thx-slider-section">
		<rs-module-wrap id="rev_slider_30_1_wrapper" data-alias="slider-9" data-source="gallery" style="visibility:hidden;background:transparent;padding:0;margin:0px auto;margin-top:0;margin-bottom:0;">
			<rs-module id="rev_slider_30_1" style="" data-version="6.5.8">
				<rs-slides>
					<rs-slide style="position: absolute;" data-key="rs-79" data-title="Slide" data-thumb="assets/trucker-g715fb0159_1920-50x100.jpg" data-anim="e:slidingoverlay;ms:1510;" data-in="o:0;x:100%;" data-out="a:false;">
						<img src="assets/trucker-g715fb0159_1920.jpg" title="trucker-g715fb0159_1920" width="1920" height="1100" class="rev-slidebg tp-rs-img" data-no-retina>
<!--
--><rs-layer
id="slider-30-slide-79-layer-0" 
data-type="text"
data-color="#ff484e"
data-rsp_ch="on"
data-xy="x:c;yo:307px,253px,192px,118px;"
data-text="w:normal;s:24,19,14,16;l:25,20,15,24;fw:500;"
data-frame_0="o:1;"
...
>We specialise in the transportation			 
							...
							>Focus on aviation<br />
							and energy 
							</rs-layer><!--

							--><a
							id="slider-30-slide-79-layer-2" 
							class="rs-layer rev-btn"
							href="#" target="_self"
							data-type="button"
							data-rsp_ch="on"
							data-xy="x:c;xo:-100px,-82px,-62px,-61px;yo:592px,488px,370px,300px;"
							data-text="w:normal;s:18,14,10,14;l:50,41,31,36;fw:500;a:center;"
							data-dim="w:auto,auto,auto,99px;h:auto,auto,auto,37px;minh:0px,none,none,none;"
							data-padding="r:40,33,25,15;l:40,33,25,15;"
							data-border="bor:3px,3px,3px,3px;"
							data-frame_0="x:-50,-41,-31,-19;"
							data-frame_1="st:4770;sp:1000;sR:4770;"
							data-frame_999="o:0;st:w;sR:3230;"
							data-frame_hover="bgc:#007aff;bor:3px,3px,3px,3px;sp:100;e:power1.inOut;bri:120%;"
							style="z-index:12;background-color:#ff484e;font-family:'Poppins';"
							>Service 
							</a><!--

							--><rs-layer
							id="slider-30-slide-79-layer-3" 
							data-type="text"
							data-rsp_ch="on"
							...
							Energy. Transformational and maturing business. <br />

							</rs-layer><!--

							--><a
							id="slider-30-slide-79-layer-4" 
							class="rs-layer rev-btn"
							href="#" target="_self"
							data-type="button"
							data-rsp_ch="on"
							data-xy="x:c;xo:81px,66px,50px,56px;yo:592px,488px,370px,301px;"
							data-text="w:normal;s:18,14,10,14;l:50,41,31,36;fw:500;a:center;"
							data-dim="w:auto,auto,auto,102px;h:auto,auto,auto,38px;minh:0px,none,none,none;"
							data-padding="r:40,33,25,15;l:40,33,25,15;"
							data-border="bor:3px,3px,3px,3px;"
							data-frame_0="x:50,41,31,19;"
							...
							data-frame_hover="bgc:#007aff;bor:3px,3px,3px,3px;sp:100;e:power1.inOut;bri:120%;"
							style="z-index:11;background-color:#ff484e;font-family:'Poppins';"
							>About Us 
							</a><!--
							-->						</rs-slide>
							<rs-slide style="position: absolute;" data-key="rs-82" data-title="Slide" data-thumb="assets/trucker-g715fb0159_1920-50x100.jpg" data-anim="e:slidingoverlay;ms:1510;" data-in="o:0;x:100%;" data-out="a:false;">
								<img src="assets/trucker-g715fb0159_1920.jpg" title="trucker-g715fb0159_1920" width="1920" height="1100" class="rev-slidebg tp-rs-img" data-no-retina>
<!--
--><rs-layer
id="slider-30-slide-82-layer-0" 
data-type="text"
data-color="#ff484e"
data-rsp_ch="on"
data-xy="x:c;yo:307px,253px,192px,118px;"
...
>We specialise in the transportation			 
							...
							-->						</rs-slide>
							<rs-slide style="position: absolute;" data-key="rs-83" data-title="Slide" data-thumb="assets/trucker-g715fb0159_1920-50x100.jpg" data-anim="e:slidingoverlay;ms:1510;" data-in="o:0;x:100%;" data-out="a:false;">
								<img src="assets/trucker-g715fb0159_1920.jpg" title="trucker-g715fb0159_1920" width="1920" height="1100" class="rev-slidebg tp-rs-img" data-no-retina>
<!--
--><rs-layer
						...
						<div class="ft-thx-feature-innerbox headline pera-content">
							<div class="ft-thx-inner-item">
								...
								<div class="ft-thx-inner-text">
									...
									<p>Build relationships and share your company values with well-crafted content tailored</p>
								</div>
							</div>
						</div>
					</div>
	...
	<section id="pr-cor-service" class="pr-cor-service-section position-relatives">
		...
		<div class="container">
			<div class="pr-cor-section-title headline pera-content middle-align text-center  wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
				<span class="pr-cor-title-tag">What we do</span>
				<h2>We Provide all Kinds of
				Logistics Service</h2>
			</div>
			<div class="pr-cor-service-content">
				<div class="row">
					<div class="col-lg-3 col-md-6  wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
						<div class="pr-cor-service-innerbox">
							<div class="pr-cor-service-inner-img">
								<img src="assets/imgs/service/ser4.jpg" alt="">
							</div>
							<div class="pr-cor-service-inner-text position-relative headline pera-content">
								...
								<div class="pr-cor-service-btn position-absolute">
									<a class="d-flex  align-items-center" href="#">Learn More <i class="far fa-angle-double-right"></i></a>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6  wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
						<div class="pr-cor-service-innerbox">
							<div class="pr-cor-service-inner-img">
								<img src="assets/imgs/service/ser4.4.jpg" alt="">
							</div>
							<div class="pr-cor-service-inner-text position-relative headline pera-content">
								<div class="pr-cor-service-icon position-absolute justify-content-center align-items-center d-flex">
									<i class="flaticon-boat"></i>
								</div>
								<h3><a href="#">Ocen Freight</a></h3>
								<p>Lorem ipsum dolor sit ame consectetur adipiscing .</p>
								<div class="pr-cor-service-btn position-absolute">
									<a class="d-flex  align-items-center" href="#">Learn More <i class="far fa-angle-double-right"></i></a>
								</div>
					...
					<div class="col-lg-3 col-md-6  wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
						<div class="pr-cor-service-innerbox">
							<div class="pr-cor-service-inner-img">
								<img src="assets/imgs/service/ser4.2.jpg" alt="">
							</div>
							<div class="pr-cor-service-inner-text position-relative headline pera-content">
								<div class="pr-cor-service-icon position-absolute justify-content-center align-items-center d-flex">
									<i class="flaticon-logistics"></i>
								</div>
								<h3><a href="#">Cargo Container</a></h3>
								<p>Lorem ipsum dolor sit ame consectetur adipiscing .</p>
								<div class="pr-cor-service-btn position-absolute">
									<a class="d-flex  align-items-center" href="#">Learn More <i class="far fa-angle-double-right"></i></a>
								</div>
					...
					<div class="col-lg-3 col-md-6  wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
						<div class="pr-cor-service-innerbox">
							<div class="pr-cor-service-inner-img">
								<img src="assets/imgs/service/ser4.3.jpg" alt="">
							</div>
							<div class="pr-cor-service-inner-text position-relative headline pera-content">
								<div class="pr-cor-service-icon position-absolute justify-content-center align-items-center d-flex">
									<i class="flaticon-free-shipping"></i>
								</div>
								<h3><a href="#">Road Transport</a></h3>
								<p>Lorem ipsum dolor sit ame consectetur adipiscing .</p>
								<div class="pr-cor-service-btn position-absolute">
									<a class="d-flex  align-items-center" href="#">Learn More <i class="far fa-angle-double-right"></i></a>
								</div>
				...
				<div class="ft-thx-btn d-flex justify-content-center text-center wow flipInX" data-wow-delay="200ms" data-wow-duration="1500ms">
					<a class="d-flex justify-content-center align-items-center" href="#">More Service</a>
				</div>
			</div>
		</div>
	</section>		
				...
				<div class="row">
							...
							<div class="row">
								...
								<div class="col-md-6 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
									<div class="pr-an-why-choose-feature-item">
										...
										<div class="pr-an-why-choose-ft-text headline pera-content">
											<h3><a href="#">Ship everywhere</a></h3>
											<p>Do eiusmod tempor incididunt ut labore et dolore aliqua.</p>
										</div>
									</div>
								</div>
								<div class="col-md-6 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
									<div class="pr-an-why-choose-feature-item">
										...
										<div class="pr-an-why-choose-ft-text headline pera-content">
											<h3><a href="#">Fastest Shipping</a></h3>
											<p>Do eiusmod tempor incididunt ut labore et dolore aliqua.</p>
										</div>
									</div>
								</div>
					...
					<div class="col-lg-6">
						<div class="pr-an-why-choose-text-wrapper">
							<div class="pr-cor-section-title headline pera-content wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
								<span class="pr-cor-title-tag">Why Choos us</span>
								<h2>We Provide the Best Facilites
								For Transport</h2>
								<p>From keyword research to technical auditing to site migration, our team of technical SEOs are true experts in their field.</p>
							</div>
							...
							<div class="ft-thx-btn text-center wow flipInX" data-wow-delay="200ms" data-wow-duration="1500ms">
								<a class="d-flex justify-content-center align-items-center" href="#">Learn More</a>
							</div>
						</div>
					</div>
				</div>
...
<!-- Start of Work Process section
	...
	<section id="ft-thx-work-process" class="ft-thx-work-process-section position-relative">
		...
		<div class="container">
			<div class="pr-cor-section-title headline pera-content middle-align text-center  wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
				<span class="pr-cor-title-tag">How It Work</span>
				...
				<div class="row justify-content-center">
					...
					<div class="col-lg-4 col-md-6 wow fadeFromTop" data-wow-delay="600ms" data-wow-duration="1500ms">
						<div class="td-sv-work-step-inner-item text-center">
							...
							<div class="td-sv-work-step-text headline pera-content">
								<h3>3. Ready To Go Your Goods</h3>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
								Tempor incididunt</p>
							</div>
						</div>
...
<!-- Start of portfolio section
	============================================= -->
	<section id="ft-thx-project" class="ft-thx-project-section position-relative"> 
		<div class="container">
			<div class="ft-thx-project-content position-relative">
				<div class="ft-thx-project-top  d-flex justify-content-between align-items-center">
					<div class="pr-cor-section-title headline pera-content wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						<span class="pr-cor-title-tag">Project</span>
						<h2>Let's Checkout our All Latest Project</h2>
					</div>
					<div class="carousel_nav clearfix">
						<button type="button" class="port_left_arrow"><i class="fal fa-arrow-left"></i></button>
						<button type="button" class="port_right_arrow"><i class="fal fa-arrow-right"></i></button>
					</div>
				</div>
			</div>
		</div>
		<div class="ft-thx-project-slider-area">
			<div class="ft-thx-project-slider">
				<div class="ft-thx-project-slider-item">
					<div class="ft-thx-inner-item position-relative">
						<div class="ft-thx-inner-img">
							<img src="assets/imgs/project/port1.jpg" alt="">
						</div>
						<div class="ft-thx-inner-text headline">
							<span><a href="#">Air Delivery</a></span>
							<h3><a href="project-single.html">Service & Aftermarket
							Logistics</a></h3>
							<a class="read-more d-flex justify-content-center align-items-center" class="read-more" href="#">+</a>
						</div>
					</div>
				</div>
				<div class="ft-thx-project-slider-item">
					<div class="ft-thx-inner-item position-relative">
						<div class="ft-thx-inner-img">
							<img src="assets/imgs/project/port4.jpg" alt="">
						</div>
						<div class="ft-thx-inner-text headline">
							<span><a href="#">Air Delivery</a></span>
							<h3><a href="project-single.html">Service & Aftermarket
				...
				<div class="ft-thx-project-slider-item">
					<div class="ft-thx-inner-item position-relative">
						<div class="ft-thx-inner-img">
							<img src="assets/imgs/project/port2.jpg" alt="">
						</div>
						<div class="ft-thx-inner-text headline">
							<span><a href="#">Air Delivery</a></span>
							<h3><a href="project-single.html">Service & Aftermarket
				...
				<div class="ft-thx-project-slider-item">
					<div class="ft-thx-inner-item position-relative">
						<div class="ft-thx-inner-img">
							<img src="assets/imgs/project/port3.jpg" alt="">
						</div>
						<div class="ft-thx-inner-text headline">
							<span><a href="#">Air Delivery</a></span>
							<h3><a href="project-single.html">Service & Aftermarket
...
<!-- Start of Testimonial section
	...
	<section id="ft-thx-testimonial" class="ft-thx-testimonial-section" data-background="assets/imgs/bg/tst-bg.jpg">
		<div class="container">
			<div class="pr-cor-section-title headline pera-content middle-align text-center  wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
				<span class="pr-cor-title-tag">Testimonial</span>
			...
			<div class="pr-sv-testimonial-content position-relative">
				<div class="pr-sv-testimonial-shape-img  ul-li-block">
					<ul>
						<li><img src="assets/imgs/ts1.png" alt=""></li>
						<li><img src="assets/imgs/ts2.png" alt=""></li>
						<li><img src="assets/imgs/ts3.png" alt=""></li>
						<li><img src="assets/imgs/ts4.png" alt=""></li>
						<li><img src="assets/imgs/ts5.png" alt=""></li>
					</ul>
				</div>
				<div class="pr-sv-testimonial-slider">
					<div class="pr-sv-testimonial-item position-relative">
						<div class="pr-sv-testimonial-img">
							<img src="assets/imgs/tst1.2.jpg" alt="">
						</div>
						<div class="pr-sv-testimonial-text pera-content headline">
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Etp Quis ipsum suspendisse ultrices gravida. Risus commodo lorem viverra maecenas accumsan lacus vel facilisis. </p>
							<h3>Monica Albert</h3>
...
<!-- Start of Blog  section
	...
	<section id="pr-cor-blog" class="pr-cor-blog-section">
		<div class="container">
			<div class="pr-cor-section-title headline pera-content middle-align text-center wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
				<span class="pr-cor-title-tag">OUR BLOG</span>
				<h2>Creative Selection
				Latest News</h2>
			</div>
			<div class="pr-cor-blog-content">
				<div class="pr-cor-blog-slider">
					<div class="pr-item-innerbox wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
						<div class="pr-cor-blog-innerbox">
							<div class="pr-cor-blog-inner-img">
								<img src="assets/imgs/blog/blg2.jpg" alt="">
							</div>
							<div class="pr-cor-blog-inner-text headline position-relative">
								<span class="pr-cor-blog-cat"><a href="#">Container</a></span>
								<div class="pr-cor-blog-meta">
									<a href="#"><i class="far fa-user"></i> Admin</a>
									<a href="#"><i class="fal fa-calendar-alt"></i> 6/23/2021</a>
								</div>
								<h3><a href="#">Special benefit through  Invest
								by your money</a></h3>
								<a class="pr-cor-blog-more" href="#">Read More <i class="far fa-arrow-right"></i></a>
							</div>
						</div>
					</div>
					<div class="pr-item-innerbox wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
						<div class="pr-cor-blog-innerbox">
							<div class="pr-cor-blog-inner-img">
								<img src="assets/imgs/blog/blg1.jpg" alt="">
							</div>
							<div class="pr-cor-blog-inner-text headline position-relative">
								<span class="pr-cor-blog-cat"><a href="#">Transport</a></span>
								<div class="pr-cor-blog-meta">
									<a href="#"><i class="far fa-user"></i> Admin</a>
									<a href="#"><i class="fal fa-calendar-alt"></i> 6/23/2021</a>
								</div>
					...
					<div class="pr-item-innerbox wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
						<div class="pr-cor-blog-innerbox">
							<div class="pr-cor-blog-inner-img">
								<img src="assets/imgs/blog/blg3.jpg" alt="">
							</div>
							<div class="pr-cor-blog-inner-text headline position-relative">
								<span class="pr-cor-blog-cat"><a href="#">Shipping</a></span>
								<div class="pr-cor-blog-meta">
									<a href="#"><i class="far fa-user"></i> Admin</a>
									<a href="#"><i class="fal fa-calendar-alt"></i> 6/23/2021</a>
								</div>
					...
					<div class="pr-item-innerbox">
						<div class="pr-cor-blog-innerbox">
							...
							<div class="pr-cor-blog-inner-text headline position-relative">
								<span class="pr-cor-blog-cat"><a href="#">Logistics</a></span>
								<div class="pr-cor-blog-meta">
									<a href="#"><i class="far fa-user"></i> Admin</a>
									<a href="#"><i class="fal fa-calendar-alt"></i> 6/23/2021</a>
								</div>
					...
					<div class="pr-item-innerbox">
						<div class="pr-cor-blog-innerbox">
							...
							<div class="pr-cor-blog-inner-text headline position-relative">
								<span class="pr-cor-blog-cat"><a href="#">Cargo</a></span>
								<div class="pr-cor-blog-meta">
									<a href="#"><i class="far fa-user"></i> Admin</a>
									<a href="#"><i class="fal fa-calendar-alt"></i> 6/23/2021</a>
								</div>
