	...
	<section id="ft-faq-page" class="ft-faq-page-section page-padding">
		<div class="container">
			<div class="ft-faq-page-top-content d-flex justify-content-between align-items-end flex-wrap">
				...
				<div class="ft-btn-3">
					<a class="d-flex justify-content-center align-items-center" href="contact.html">Get a Query <i class="flaticon-right-arrow"></i></a>
				</div>
			</div>
						...
						<div class="ft-faq-contact-form-area">
							...
							<form action="#">
								<div class="row">
									...
									<div class="col-md-12">
										<button class="ft-submit-btn">Submit Now <i class="flaticon-right-arrow"></i></button>
									</div>
								</div>
							</form>
						</div>
